...
int main( int argc, char** argv )
{
    ...
    cout<<"Check Point No: 1"<<endl;
    load_images( pos_dir, pos, pos_lst );
    cout<<"Positive Images loaded"<<endl;
    labels.assign( pos_lst.size(), +1 );
    cout<<"Labels Assigned"<<endl;
    const unsigned int old = (unsigned int)labels.size();
    load_images( neg_dir, neg, neg_lst );
    cout<<"Negative Images Loaded"<<endl;
    //sample_neg( full_neg_lst, neg_lst, Size( 30,60 ) );
