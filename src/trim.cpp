...
void onMouse( int event, int x, int y, int f, void* ){
    ...
    switch(event){
        ...
        case  CV_EVENT_MOUSEMOVE    :
                                        if(clicked){
                                        P2.x=P1.x+(y-P1.y)/2; // Inorder to crop out a rectangular patch of in ratio 2:1 for Y:X
                                        P2.y=y;
                                        }
                                        break;
...
int main()
{
    ...
    string line;
    ifstream myfile ("../data/music_notation/list.txt");
    cout <<"Success"<<endl;
    if (myfile.is_open())
    {
